...
HD_PWD='/home/parallels/Documents/ECE338/lab01/lab01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_ED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FA_ED.tcl -notrace
