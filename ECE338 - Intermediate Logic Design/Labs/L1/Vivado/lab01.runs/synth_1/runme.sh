...
HD_PWD='/home/parallels/Documents/ECE338/lab01/lab01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_ED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA_ED.tcl
