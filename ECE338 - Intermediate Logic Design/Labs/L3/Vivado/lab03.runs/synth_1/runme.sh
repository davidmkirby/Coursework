...
HD_PWD='/home/parallels/Documents/ECE338/lab03/lab03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PriorityMUX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PriorityMUX.tcl
